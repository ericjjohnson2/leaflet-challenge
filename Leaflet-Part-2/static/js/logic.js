...
function createMap(earthquake) {
  ...
  let satelliteMap = L.tileLayer('https://cartodb-basemaps-{s}.global.ssl.fastly.net/dark_all/{z}/{x}/{y}.png', {
    attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
  });
  ...
  let myMap = L.map("map", {
    center: [37.09, -95.71],
    zoom: 5,
    layers: [street, satelliteMap, earthquake]
  });
  ...
  L.control.layers(baseMaps, overlayMaps, satelliteMap, {
    collapsed: false
  }).addTo(myMap);
};
